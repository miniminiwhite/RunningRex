...
import com.jamescho.game.state.PauseState;
import com.jamescho.game.state.PlayState;
import com.jamescho.game.state.StartState;
...
public class GameView extends SurfaceView implements Runnable {
	...
	private volatile State currentState, formerState;
		...
		holder.addCallback(new Callback() {
			...
			public void surfaceCreated(SurfaceHolder holder) {
				...
				if (currentState == null) {
					setCurrentState(new LoadState(), true);
				}
				initGame();
			}
	...
	public void setCurrentState(State newState, boolean initNeeded) {
		System.gc();
        if (initNeeded) {
            newState.init();
        }
    ...
    public void setCurrentState(int StateNum) throws Exception {
        switch (StateNum) {
            ...
            case State.PAUSESTATE:
                setCurrentState(new PauseState((PlayState) currentState, false), true);
        }
    }

	public int getCurrentStateNum() {
		return currentState.getStateNum();
	}
